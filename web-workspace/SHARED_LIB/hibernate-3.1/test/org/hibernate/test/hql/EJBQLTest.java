//$Id: EJBQLTest.java,v 1.21 2005/07/12 20:49:27 oneovthafew Exp $
...
public class EJBQLTest
	...
	private QueryTranslatorImpl compile(String input) {
		SessionFactoryImplementor factory = getSessionFactoryImplementor();
		QueryTranslatorFactory ast = new ASTQueryTranslatorFactory();
		QueryTranslator queryTranslator = ast.createQueryTranslator( input, Collections.EMPTY_MAP, factory );
		queryTranslator.compile( Collections.EMPTY_MAP, true );
