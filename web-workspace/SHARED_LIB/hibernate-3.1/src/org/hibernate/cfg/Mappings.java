//$Id: Mappings.java,v 1.31 2005/12/02 20:45:35 maxcsaucdk Exp $
...
public class Mappings implements Serializable {
	...
	public void addTableBinding(
		...
		if ( oldDescriptor != null && ! oldDescriptor.logicalName.equals( logicalName ) ) {
			...
			throw new MappingException("Same physical table name reference several logical table names: "
					+ physicalName + " => " + oldDescriptor.logicalName + ", " + logicalName);
		}
	}
	...
	public void addColumnBinding(String logicalName, Column finalColumn, Table table) {
		...
		if ( oldFinalName != null && ! oldFinalName.equals( finalColumn.getQuotedName() ) ) {
			//TODO possibly relax that
			throw new MappingException("Same logical column name referenced several times: "
					+ table.getName() + "." + logicalName + " " + oldFinalName + " " + finalColumn.getQuotedName() );
		}
		...
		if ( oldLogicalName != null && ! oldLogicalName.equals( logicalName ) ) {
			//TODO possibly relax that
			throw new MappingException("Same physical column represented by 2 logical column names: "
					+ table.getName() + "." + finalColumn.getQuotedName() + " => " + oldLogicalName + " " + logicalName);
		}
	}
