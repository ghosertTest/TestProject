//$Id: SessionImpl.java,v 1.169 2005/12/09 04:08:43 oneovthafew Exp $
...
public final class SessionImpl extends AbstractSessionImpl 
	...
	public SessionFactoryImplementor getFactory() {
		// IMPORTANT!!! do *not* attempt to register the synchronization
		// here, as that could cause infinite circularity
		return factory;
	}
