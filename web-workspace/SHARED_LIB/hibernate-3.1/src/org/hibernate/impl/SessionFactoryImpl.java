//$Id: SessionFactoryImpl.java,v 1.102 2005/11/21 15:33:30 steveebersole Exp $
...
public final class SessionFactoryImpl implements SessionFactory, SessionFactoryImplementor {
	...
	private Map checkNamedQueries() throws HibernateException {
		...
		log.info("Checking " + namedQueries.size() + " named HQL queries");
		...
		log.info("Checking " + namedSqlQueries.size() + " named SQL queries");
	...
	public Type[] getReturnTypes(String queryString) throws HibernateException {
		return queryPlanCache.getHQLQueryPlan( queryString, true, CollectionHelper.EMPTY_MAP ).getReturnMetadata().getReturnTypes();
	}

	public String[] getReturnAliases(String queryString) throws HibernateException {
		return queryPlanCache.getHQLQueryPlan( queryString, true, CollectionHelper.EMPTY_MAP ).getReturnMetadata().getReturnAliases();
	}
