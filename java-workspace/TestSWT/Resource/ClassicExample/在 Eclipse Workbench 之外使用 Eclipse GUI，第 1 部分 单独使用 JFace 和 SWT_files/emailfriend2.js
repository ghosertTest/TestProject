...
function newWindow() {
        ...
        window.location.assign("https://www-130.ibm.com/developerworks/secure/email-it.jsp?subject=" + escape(justTitle) + "&url=" + escape(document.location.href) + "&body=" + escape(emailAbstract));
}                  
